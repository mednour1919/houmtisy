 ...
 */
class getRouting_LoaderService extends App_KernelMDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('m');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'm'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'm'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'm'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'm'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'm'));
