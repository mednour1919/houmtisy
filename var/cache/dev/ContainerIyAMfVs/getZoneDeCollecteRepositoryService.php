 ...
 */
class getZoneDeCollecteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ZoneDeCollecteRepository' shared autowired service.
     *
     * @return \App\Repository\ZoneDeCollecteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ZoneDeCollecteRepository.php';

        return $container->privates['App\\Repository\\ZoneDeCollecteRepository'] = new \App\Repository\ZoneDeCollecteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
