 ...
 */
class getDepenseProjetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DepenseProjetRepository' shared autowired service.
     *
     * @return \App\Repository\DepenseProjetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DepenseProjetRepository.php';

        return $container->privates['App\\Repository\\DepenseProjetRepository'] = new \App\Repository\DepenseProjetRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
