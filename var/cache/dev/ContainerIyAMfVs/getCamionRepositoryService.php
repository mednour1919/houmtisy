 ...
 */
class getCamionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CamionRepository' shared autowired service.
     *
     * @return \App\Repository\CamionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CamionRepository.php';

        return $container->privates['App\\Repository\\CamionRepository'] = new \App\Repository\CamionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
